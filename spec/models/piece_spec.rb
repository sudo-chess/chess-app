 ...
 #failing
  describe "is_in_checkmate?" do
   it "should return true if king is in checkmate" do
     ...
     piece2 = Queen.create(position_x: 1, position_y: 2, color: "white", game_id: game.id)
     piece3 = Queen.create(position_x: 2, position_y: 2, color: "white", game_id: game.id)
...
#failing
  describe "is_in_checkmate?" do
   it "should return true if king is in checkmate" do
     ...
     piece2 = Queen.create(position_x: 2, position_y: 6, color: "black", game_id: game.id)
     piece3 = Rook.create(position_x: 4, position_y: 8, color: "black", game_id: game.id)
